...
implicados:
  - nombre: "Francisco Triguero"
    ...
    rol: "Condenado a 1 año de prisión por fraude de subvenciones a FIBIC"

  - nombre: "Joaquín Torres"
    cargo: "Coordinador de la Dirección General de Universidades y Secretario General de la Agencia Andaluza del Conocimiento"
    rol: "Condenado a 1 año de prisión por colaborar en el fraude de subvenciones"

  - nombre: "Felipe Romera"
    cargo: "Director del Parque Tecnológico de Andalucía (PTA)"
    rol: "Absuelto tras retirada de la acusación por la Fiscalía"

  - nombre: "Juan Manuel Suárez Japón"
    cargo: "Rector de la Universidad Internacional de Andalucía (UNIA)"
    rol: "Absuelto tras retirada de la acusación por la Fiscalía"
...
impactoSocial: "El caso CIBIC es uno de los múltiples escándalos de gestión irregular de fondos públicos durante los gobiernos socialistas en Andalucía, que evidenció los fallos de control en la concesión de subvenciones excepcionales. Aunque de menor repercusión mediática que el caso ERE, ilustra el patrón sistemático de uso irregular de dinero público que acabó con 37 años de hegemonía del PSOE en la Junta de Andalucía."

documentos: []

cronologia:
  - fecha: "2007-06-21"
    titulo: "Constitución de la FIBIC"
    descripcion: "Se inscribe en el Registro de Fundaciones de Andalucía la Fundación Instituto de Innovación para el Bienestar Ciudadano (FIBIC), con domicilio en el Parque Tecnológico de Andalucía (PTA) de Campanillas, Málaga. La fundación agrupa a la Universidad Internacional de Andalucía (UNIA) y a la Consejería de Innovación de la Junta, y tiene por objeto promover la innovación en bienestar ciudadano. Su proyecto estrella es la construcción del edificio CIBIC (Centro de Innovación para el Bienestar Ciudadano) en el PTA."
    type: "resumen"
    urls:
  ...
  - fecha: "2012-07-20"
    titulo: "La Junta concede una subvención excepcional de 15,5 millones a la FIBIC"
    descripcion: "La Secretaría General de Universidades, Investigación y Tecnología de la Junta de Andalucía publica en el BOJA la concesión de una subvención excepcional de 15.511.163,91 euros a la Fundación Instituto de Innovación para el Bienestar Ciudadano (FIBIC) para la inversión denominada 'CIBIC - Construcción del Centro Abierto de Innovación'. La subvención, de carácter excepcional, elude los procedimientos ordinarios de concurrencia competitiva."
    type: "documento"
    urls:
  ...
  - fecha: "2017-11-01"
    titulo: "El juicio oral se fija para diciembre de 2017"
    descripcion: "El Juzgado de lo Penal número 11 de Málaga señala el juicio oral por las presuntas irregularidades en las subvenciones a la FIBIC para los días 11 al 15 de diciembre de 2017. La Fiscalía acusa a seis personas, entre ellas Francisco Triguero (exsecretario general de Universidades), Felipe Romera (director del PTA), Joaquín Torres y otros funcionarios, por un delito de fraude de subvenciones, y solicita tres años de prisión para los principales acusados."
    type: "investigación"
    urls:
      - "https://www.marbellaconfidencial.es/juicio-las-subvenciones-irregulares-la-fundacion-fibic-se-celebrara-diciembre-131341138/"
