...
resumen: "Trama de corrupción en Acuamed que amañó contratos de obras hidráulicas mediante sobornos a funcionarios"
coste: 20000000
lugar: "Comunidad Valenciana, España"
tribunal:
  - "Audiencia Nacional - Juzgado Central de Instrucción nº 6 - Juez Manuel García Castellón - Fiscalía Anticorrupción"
numeroSentencia: ""
implicados:
...
impactoSocial: "El caso Acuamed reveló una de las tramas de corrupción más graves en la gestión del agua en España, afectando a infraestructuras hídricas críticas para el abastecimiento de la cuenca mediterránea. La implicación de un exministro convertido en Comisario Europeo generó un escándalo político internacional, aunque el Parlamento Europeo rechazó llamarle a comparecer. La Operación Frontino destapó cómo empresas constructoras de primera línea participaban sistemáticamente en sobornos para obtener contratos públicos millonarios."
...
cronologia:
  - fecha: "2016-01-18"
    ...
    descripcion: "La Unidad Central Operativa (UCO) de la Guardia Civil ejecuta la Operación Frontino en las primeras horas de la mañana, registrando la sede de Acuamed en Madrid y las sedes de Acciona Infraestructuras, FCC Construcción y Pipeline en Valencia, Alicante y Castellón. La operación concluye con la detención de 13 personas, incluidos el director general de Acuamed, Arcadio Mateo del Puerto; la directora de Ingeniería y Construcción, María Gabriela Mañueco; el responsable de Contratación, Francisco Javier Gómez Pastor; el delegado en Valencia, Pablo Martín; el presidente de Altec, Nicolás Steegmann, y nueve empresarios. Los detenidos son acusados de organización criminal, prevaricación, fraude, malversación, cohecho, tráfico de influencias y falsedad documental."
    type: "detención"
    urls:
      - "https://www.cuartopoder.es/espana/2016/01/21/18071/"
      - "https://casos-aislados.com/Caso-Aislado.php?Caso=Caso+Acuamed&numero=185"
  ...
  - fecha: "2016-01-21"
    ...
    descripcion: "Los medios de comunicación revelan detalles escabrosos de la investigación judicial: el exdirector general de Acuamed, Arcadio Mateo, recibió de las empresas contratistas regalos en forma de viajes dentro y fuera de España, e incluso un implante capilar en Turquía valorado en 4.500 euros. La investigación judicial documenta que los sobornos incluían viajes de caza, estancias de lujo, regalos de alto valor y dinero en efectivo a cambio de adjudicaciones irregulares. El caso evidencia cómo la corrupción en Acuamed llegó hasta los detalles más personales e íntimos de los implicados."
    type: "resumen"
    urls:
      - "https://www.cuartopoder.es/espana/2016/01/21/18071/"
  ...
  - fecha: "2016-01-28"
    ...
    descripcion: "El expediente judicial del caso Acuamed menciona repetidamente al exministro de Agricultura Miguel Arias Cañete, quien dirigió el departamento del que dependía Acuamed entre 2011 y 2014, antes de convertirse en Comisario Europeo de Acción por el Clima y Energía. El denunciante Francisco Manuel Valiente González declara ante el juez que el director general Arcadio Mateo le confesó en 2013 que la adjudicación inflada de un contrato a FCC procedía de 'órdenes directas' del ministro Cañete. Arcadio Mateo había llegado a Acuamed como persona de confianza de Cañete y mantenía estrechas conexiones con María Dolores de Cospedal, secretaria general del PP."
    type: "investigación"
    urls:
  ...
  - fecha: "2021-02-13"
    titulo: "Audiencia Nacional exonera a imputado contra criterio de Anticorrupción"
    descripcion: "El juez de la Audiencia Nacional archiva parcialmente la causa contra uno de los imputados en el caso Acuamed al no encontrar pruebas suficientes para mantener la acusación, a pesar de la oposición de la Fiscalía Anticorrupción. La decisión comienza a generar dudas sobre la solidez de la investigación tras cinco años desde las primeras detenciones. Varios medios titulan que 'el caso Acuamed agoniza', aunque la instrucción continúa para la mayoría de procesados."
    type: "investigación"
    urls:
  ...
  - fecha: "2022-04-18"
    titulo: "Fiscalía Europea rechaza investigar el caso"
    descripcion: "La Fiscalía Europea decide dejar el caso Acuamed fuera de su ámbito de competencia y devolverlo a la jurisdicción española, argumentando que no tiene autoridad para investigar hechos ocurridos antes de su creación. El juez Manuel García Castellón, que había asumido la instrucción tras el juez Velasco, ultima los trámites para el cierre de la fase de investigación y el procesamiento formal de los acusados. La decisión europea acelera el procedimiento para llevar el caso a juicio oral en la Audiencia Nacional."
    type: "investigación"
    urls:
